...
def test_search_product_driver(driver):
    ...
    assert driver.current_url._contains_('wireless'),'Search results page did not load.'
    assert driver.title._contains_('wireless'),'Search results page did not load.'
